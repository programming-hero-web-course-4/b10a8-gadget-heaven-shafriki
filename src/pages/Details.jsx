              ...
              <div className="bg-white   text-black max-w-screen-lg mx-auto absolute top-28 p-4  rounded-lg shadow-lg">
                <div className="hero-content flex flex-col  lg:flex-row">
                  <img
                    ...
                    className="max-w-full lg:max-w-sm rounded-lg mb-4 lg:mb-0 lg:mr-6 border-2 py-2" 
                  />
                  <div className="flex flex-col items-start justify-between">
                    ...
                    <button className="btn btn-primary rounded-full mt-4 w-full">Add to Cart<i class="fa-solid fa-cart-shopping"></i></button>
                    <i class="fa-regular fa-heart mt-5 bg-gray-200 p-1 rounded-full border-2"></i>
                    </div>
                  </div>
                </div>
              </div>
